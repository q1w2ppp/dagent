...
async function analyzeImage(imageData,mimeType){
  return new Promise(async(resolve,reject)=>{
    ...
    try{
      ...
      const body=JSON.stringify({model:'glm-4.6v',messages:[{role:'user',content:[{type:'text',text:'请分析后面图片的设计风格、配色、排版，推荐设计师和比赛'},{type:'image',image_url:{url:imgUrl}}]}],max_tokens:1000});
